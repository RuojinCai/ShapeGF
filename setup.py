...
#     sources=["im2mesh/utils/libmesh/triangle_hash.pyx"],
#     libraries=["m"],  # Unix-like specific
# )

# mise (efficient mesh extraction)
mise_module = Extension("utils.libmise.mise", sources=["./utils/libmise/mise.pyx"],)

# simplify (efficient mesh simplification)
# simplify_mesh_module = Extension(
#     "im2mesh.utils.libsimplify.simplify_mesh",
#     sources=["im2mesh/utils/libsimplify/simplify_mesh.pyx"],
# )
